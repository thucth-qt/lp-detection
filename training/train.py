...
from ailibs.utils.datasets import LoadImagesAndLabels
from ailibs.utils.parse_config import parse_data_cfg
from ailibs.utils.plot import plot_images, plot_results
...
def train(hyp):
    ...
    if opt.freeze_layers:
        from ailibs.detector.yolov3.models import YOLOLayer
...
def evolve():
    ...
    for _ in range(1):  # generations to evolve
        ...
        limits = [(1e-5, 1e-2), (0.00, 0.95), (0.60, 0.98), (0, 0.001), (0, .9), (0, .9), (0, .9), (0, .9), (0, 3)]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov3-lp.cfg', help='*.cfg path')
    parser.add_argument('--data', type=str, default='lp.data', help='*.data path')
